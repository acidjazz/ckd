...
#Jobs.page
  Card(page="Jobs")
  .container
    .bigtitle.is-h1(v-in-viewport) Job Openings
    .clear

    .jobs-list
      .title.is-h4(v-in-viewport) DESIGNER  

      .subtitle.is-h2(v-in-viewport) Responsibilities
      ul(v-in-viewport)
      ...
      .subtitle.is-h2(v-in-viewport) Qualifications
      ul(v-in-viewport)
      ...
      .title.is-h1(v-in-viewport) DESIGN ASSISTANT
      .subtitle.is-h2(v-in-viewport) Responsibilities
      ul(v-in-viewport)
    ...
    .apply(v-in-viewport) To apply for a position, please submit a resume and portfolio to 
